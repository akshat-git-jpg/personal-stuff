...
but do not stop the import.`,
  ...
  paypal-txns-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  paypal-txns-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | paypal-txns-pp-cli import <resource> --input -`,
