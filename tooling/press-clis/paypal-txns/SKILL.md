---
name: pp-paypal-txns
description: "Read-only PayPal income reporting that handles the 31-day window limit for you - pull months of transactions and a Trigger phrases: `how much did I make on paypal`, `paypal income last few months`, `paypal monthly income`, `export my paypal transactions`, `paypal transaction history`, `use paypal-txns`, `run paypal-txns`."
