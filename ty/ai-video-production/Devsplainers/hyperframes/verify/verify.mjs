...
/* ============================================================================
   ...
   Usage (from the hyperframes/ project root):
     node verify/verify.mjs kit/examples/01-title-card
     node verify/verify.mjs videos/<slug>/scenes/s01-foo --json
...
if (!sceneRel) {
  console.error('usage: node verify/verify.mjs <scene-folder> [--json]');
  process.exit(2);
}
