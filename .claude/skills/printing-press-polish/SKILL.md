...
if command -v gosec >/dev/null 2>&1; then
  ...
  go run github.com/securego/gosec/v2/cmd/gosec@v2.21.4 -fmt=json -out=/tmp/polish-gosec-before.json ./... 2>&1 || true
fi
```
...
if command -v gosec >/dev/null 2>&1; then
  ...
  go run github.com/securego/gosec/v2/cmd/gosec@v2.21.4 -fmt=json -out=/tmp/polish-gosec-after.json ./... 2>&1 || true
fi
```
