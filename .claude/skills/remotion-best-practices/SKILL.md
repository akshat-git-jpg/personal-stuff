...
description: Best practices for Remotion (video creation in React). Use when scaffolding a new Remotion project, writing or reviewing Remotion code, building compositions, animations, transitions, audio, captions, or rendering video frames. Triggers on "remotion", "video composition", "create video", "animation timing", "render frame", or any task involving Remotion APIs.
user-invocable: true
metadata:
  author: kbtg
  version: 1.0.0
