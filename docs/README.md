...
- Loose handoff and workflow documents:
  ...
  - Working checklists: `2026-08-28-youtube-description-link-swaps.md` (64 videos / 96 links to swap from `agrolloo.com/<tool>` to `go.agrolloo.com/<code>/<tool>`, ordered by view count; written because only 3 of 68 published videos were sending clicks to the redirector at all. Tick rows off as the descriptions are edited; delete the file once empty).
