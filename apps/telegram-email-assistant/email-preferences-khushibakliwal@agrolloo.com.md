# Email Preferences — agrolloo (khushibakliwal@agrolloo.com)
...
- **Hosting & domain** — Hostinger, Cloudflare: renewals, expiry warnings,
  billing failures, DNS or deliverability notices

## Digest noise rules

This inbox carries a lot of automated marketing. Push these down, never into
Part 2, unless a focus area above clearly applies:
