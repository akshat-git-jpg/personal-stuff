...
// No BEGIN/COMMIT: D1 rejects SQL transaction statements outright ("please use
// state.storage.transaction() instead of the SQL BEGIN TRANSACTION"), and
// `wrangler d1 execute --file` already sends the statements as one batch.
const lines = ["-- generated by scripts/export-sheet-to-sql.mjs — do not edit"];
let exCount = 0;
let logCount = 0;
