...
| Need Changes | video_title, video_notes, category, subcategory, script_instruction, script_eta, script_link, script_feedback | script_link | script_link |
...
| In Review | video_title, video_notes, category, subcategory, script_instruction, tutorial_instruction, video_editor_instruction, thumbnail_instruction, script_link, script_feedback | script_instruction, tutorial_instruction, video_editor_instruction, thumbnail_instruction, script_feedback |
| Need Changes | video_title, video_notes, category, subcategory, script_instruction, tutorial_instruction, video_editor_instruction, thumbnail_instruction, script_link, script_feedback | script_instruction, tutorial_instruction, video_editor_instruction, thumbnail_instruction |
| Done | video_title, script_instruction, tutorial_instruction, video_editor_instruction, thumbnail_instruction, script_link, script_feedback | — |
...
| Need Changes | video_title, video_notes, script_link, tutorial_instruction, tutorial_eta, tutorial_link, tutorial_feedback | tutorial_link | tutorial_link |
...
| In Review | video_title, video_notes, script_link, script_instruction, tutorial_instruction, video_editor_instruction, thumbnail_instruction, tutorial_link, tutorial_feedback | script_instruction, tutorial_instruction, video_editor_instruction, thumbnail_instruction, tutorial_feedback |
| Need Changes | video_title, video_notes, script_link, script_instruction, tutorial_instruction, video_editor_instruction, thumbnail_instruction, tutorial_link, tutorial_feedback | script_instruction, tutorial_instruction, video_editor_instruction, thumbnail_instruction |
| Done | video_title, script_instruction, tutorial_instruction, video_editor_instruction, thumbnail_instruction, tutorial_link, tutorial_feedback | — |
...
| Need Changes | video_title, video_notes, tutorial_link, video_editor_instruction, video_editor_eta, video_editor_link, editor_feedback | video_editor_link | video_editor_link |
...
| In Review | video_title, video_notes, tutorial_link, script_instruction, tutorial_instruction, video_editor_instruction, thumbnail_instruction, video_editor_link, editor_feedback | script_instruction, tutorial_instruction, video_editor_instruction, thumbnail_instruction, editor_feedback |
| Need Changes | video_title, video_notes, tutorial_link, script_instruction, tutorial_instruction, video_editor_instruction, thumbnail_instruction, video_editor_link, editor_feedback | script_instruction, tutorial_instruction, video_editor_instruction, thumbnail_instruction |
| Done | video_title, script_instruction, tutorial_instruction, video_editor_instruction, thumbnail_instruction, video_editor_link, editor_feedback | — |
...
| Need Changes | video_title, video_notes, video_editor_link, thumbnail_instruction, thumbnail_eta, thumbnail_link, thumbnail_feedback | thumbnail_link | thumbnail_link |
...
| In Review | video_title, video_notes, video_editor_link, script_instruction, tutorial_instruction, video_editor_instruction, thumbnail_instruction, thumbnail_link, thumbnail_feedback | script_instruction, tutorial_instruction, video_editor_instruction, thumbnail_instruction, thumbnail_feedback |
| Need Changes | video_title, video_notes, video_editor_link, script_instruction, tutorial_instruction, video_editor_instruction, thumbnail_instruction, thumbnail_link, thumbnail_feedback | script_instruction, tutorial_instruction, video_editor_instruction, thumbnail_instruction |
| Done | video_title, script_instruction, tutorial_instruction, video_editor_instruction, thumbnail_instruction, thumbnail_link, thumbnail_feedback | — |
