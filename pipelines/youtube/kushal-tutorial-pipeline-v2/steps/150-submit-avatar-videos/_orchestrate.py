...
HERE = pathlib.Path(__file__).resolve().parent              # steps/150-submit-avatar-videos/
...
OUT = HERE / "output"
SYNTH_OUT = ROOT / "steps/080-synthesize-voice/output"
A4_AUDIO = SYNTH_OUT / "avatar-audio"
A3_PARTS = ROOT / "steps/090-plan-corner-render-parts/output/corner-parts"
