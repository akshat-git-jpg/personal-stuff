...
- the five things in every shot: the words, the main object, the background, the small extras, the camera
...
- deciding the surprise ending first, then working back to the opening line
...
- filling in the script template on screen
- what comes back: an opening, a build and a payoff, not a wall of text
- editing the draft in place instead of asking all over again
...
- listening through ten options across different moods
...
- why it feels boring at this stage, and why that is exactly right
- one simple movement per picture, timed to the line underneath it
- the beginner mistake of animating everything, and what that looks like
- running the whole set in one go, and how long it really takes
