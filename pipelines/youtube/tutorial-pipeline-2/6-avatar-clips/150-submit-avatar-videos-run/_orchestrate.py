...
HERE = pathlib.Path(__file__).resolve().parent              # 6-avatar-clips/150-submit-avatar-videos-run/
...
A3_PARTS = ROOT / "4-voiceover/090-plan-corner-render-parts-run/output/corner-parts"
