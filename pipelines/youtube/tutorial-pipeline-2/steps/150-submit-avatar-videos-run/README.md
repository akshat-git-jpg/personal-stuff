...
- **`run-a4.py`** — full-screen blocks. In: `../080-synthesize-voice-run/output/avatar-audio/*.wav`
  (one render per block). Records jobs named `<base>__a4__<block>`.
- **`run-a3.py`** — corner talking-head. In: `../090-plan-corner-render-parts-run/output/corner-parts/*.wav`
