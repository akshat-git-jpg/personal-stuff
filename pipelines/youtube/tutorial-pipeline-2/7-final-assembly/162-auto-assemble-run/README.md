...
- **In:** `../../4-voiceover/125-build-assembly-plan-run/output/<base>.assembly-plan.json` + the raw
  recording + `../../4-voiceover/100-trim-silence-run/output/<base>.voice.trim.wav` +
  `../../6-avatar-clips/160-download-avatar-videos-human/output/videos/` (A3 corner parts, A4 blocks) +
  `../../5-visuals/135-build-graphics-sonnet/output/`
