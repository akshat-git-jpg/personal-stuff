...
| &nbsp;&nbsp;&nbsp;&nbsp;[`youtube/yt-script-2/`](youtube/yt-script-2/CLAUDE.md) | Owner-supplied knowledge → outline → team member's draft back → final AI-VO script → voiceover (step 4 unwired, 2026-08-18). Any topic, any format, no research step (2026-07-31). Driven by the `yt-script-2` skill | Markdown workflow |
...
| &nbsp;&nbsp;&nbsp;&nbsp;[`video/visuals-flow/`](video/visuals-flow/PIPELINE.md) | The motion-graphics pipeline — concept/through-line pass, enacted cards, coverage+density fixes, head panel mode, sound+mix stage, two-tab review board (spec docs/specs/2026-07-24-visuals-flow-v2-design.md) | Node + Claude steps |
