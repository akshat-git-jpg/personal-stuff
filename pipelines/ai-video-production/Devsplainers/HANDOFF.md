...
- **Reverse-engineered the Devsplainers visual system** → lives in `/Users/kbtg/codebase/personal-stuff/pipelines/ai-video-production/Devsplainers/README.md` + `reference-frames/`. Key style: near-black bg, 4 semantic accent colors (white/blue/amber/red + green), condensed-grotesk + monospace type pairing, ~6 reusable components (pill badge, type-tagged card, single-weight line-art SVG icons, underlined section header, connector, accumulating corner badges). Concluded it's code-generated 2D motion graphics (Remotion-style), VO-driven, faceless.
...
- `/Users/kbtg/codebase/personal-stuff/pipelines/ai-video-production/Devsplainers/README.md` — read first; the Devsplainers visual-system reverse-engineering (colors, type, components, production method).
- `/Users/kbtg/codebase/personal-stuff/pipelines/ai-video-production/Devsplainers/reference-frames/` — 6 stills from the Devsplainers video showing the target aesthetic.
- `/Users/kbtg/codebase/personal-stuff/pipelines/ai-video-production/Devsplainers/HANDOFF.md` — this file.
