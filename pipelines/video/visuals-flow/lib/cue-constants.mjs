...
export const CUE_CONSTANTS = {
  ...
  GAP_ABSORB:             { value: 4,    rule: 'On base:screen videos, a gap to the next base event of at most 4s is absorbed by extending the previous fullframe card (a sub-4s footage flash reads as a glitch); anything longer intentionally returns to the screen recording. Was 12 until 2026-07-31: a 12s absorption re-inflated finished cards into exactly the static-screen holds the owner kept flagging (z05#2).' },
  HEAD_COVER:             { value: 6,    rule: 'The video must open on a fullframe card or a full-screen avatar, never bare screen recording (owner rule, final-v1:0 2026-07-31). When the first fullframe cue starts within 6s of t=0 and no avatar span covers the opening, the resolver pulls its start to 0 (hero state until its first beat; card-relative beat times shift accordingly). An opening gap the resolver cannot close is lint error E13.' },
