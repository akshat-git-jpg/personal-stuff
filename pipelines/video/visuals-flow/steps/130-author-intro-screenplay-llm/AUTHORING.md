...
`intro-render` (160) is the LAST step, not the review step (140), and does not
itself refuse an unapproved film — rendering is how the owner GETS a film to
watch. The approval gate (150) is enforced downstream, at assembly.
