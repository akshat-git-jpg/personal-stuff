...
const STILLS = ["vox/v7a.png", "vox/v7b.png", "vox/v7c.png"];
const CLIPS = ["vox/v7a.mp4", "vox/v7b.mp4", "vox/v7c.mp4"];
...
const CAPS: { a: number; b: number; pre: string; mark?: string; post?: string }[] = [
  { a: 0.64, b: 2.95, pre: "Animation like this used to take a motion designer" },
  { a: 3.05, b: 4.90, pre: "and weeks of ", mark: "After Effects" },
  { a: 6.26, b: 7.70, pre: "It cost ", mark: "thousands of dollars" },
  { a: 7.80, b: 9.80, pre: "per finished minute" },
  { a: 11.92, b: 14.35, pre: "This one took one person… ", mark: "one afternoon" },
  { a: 14.55, b: 15.55, pre: "You're watching the ", mark: "proof" },
];
...
export const VoxTestV7: React.FC<{ mode?: V4Mode }> = ({ mode = "seedance" }) => {
  ...
  return (
    <AbsoluteFill style={{ background: RAISIN, fontFamily: SANS }}>
      <Audio src={staticFile("vox/vo_v7.wav")} />
      ...
      <CostMeter u={u} t={qt} a={6.40} b={10.9} px={px} />
