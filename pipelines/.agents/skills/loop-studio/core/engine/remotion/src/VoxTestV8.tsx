...
const STILLS = ["vox/v8a.png", "vox/v8b.png", "vox/v8c.png"];
const CLIPS = ["vox/v8a.mp4", "vox/v8b.mp4", "vox/v8c.mp4"];
const CLIP_SECS = [6, 4, 6];   // source lengths, retimed to fill each scene window
...
export const VoxTestV8: React.FC<{ mode?: V4Mode }> = ({ mode = "seedance" }) => {
