...
export const POLICY: Record<string, RolePolicy> = {
  ...
  "Reviewer":       { visibleGroups: "*", readonlyGroups: [], editable: ["yt_upload_status","yt_upload_date","yt_link","topic_status"], rows: { match: "reviewer_email", gate: { col: "video_editor_status", equals: "Done" } }, laneStatus: "yt_upload_status" },
