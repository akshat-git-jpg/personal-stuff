...
| 089 | whip v2 + flash v2 (step 090) — reference-matched rework: 0.2s blur-cut (gblur ramp, no slide/ghost), luminous screen-blend gradient flash w/ white peak + residue band, content-timed beats; owner rejected v1 look 2026-07-19 | P1 | M | 084/085/088 landed | TODO |
| 090 | burned captions on screen segments (step 090) — planCaptions word-chunking + Pillow PNG strips (ffmpeg here has no drawtext/libass), overlay-gated per screen segment, --captions on\|off | P2 | M | 089 landed | TODO |
| 091 | Ken Burns drift on screen segments (step 090) — alternating ≤5% center-zoom via per-frame crop expr, ≥4s screens only, --drift on\|off | P3 | S | 090 landed | TODO |
